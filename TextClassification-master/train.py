...
# Data parameters
tf.flags.DEFINE_string('data_file', './data/train_wbt.csv', 'Data file path')
...
tf.flags.DEFINE_integer('max_length', 1000, 'Max document length')
...
tf.flags.DEFINE_float('learning_rate', 1e-6, 'Learning rate')  # All
...
tf.flags.DEFINE_float('decay_rate', 0.5, 'Learning rate decay rate. Range: (0, 1]')  # Learning rate decay
