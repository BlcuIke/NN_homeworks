...
# File paths
tf.flags.DEFINE_string('test_data_file', './data/test_wbt.csv', 'Test data file path')
tf.flags.DEFINE_string('run_dir', '/opt/TextClassification-master/runs/1577276369', 'Restore the model from this run')
tf.flags.DEFINE_string('checkpoint', 'clf-100', 'Restore the graph from this checkpoint')
